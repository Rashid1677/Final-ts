...
//Ans. 
let nameOfPerson: string = "Rashid Munir";
...
//Ans:
let friendsNames: string[] = ["Asad", "Muneeb", "Danissh" , "Ramzan"];
...
//Ans:
let friendsList: string[] = ["Asad", "Muneeb", "Danish", "Ramzan"];
for (let i=0; i<friendsNames.length; i++){
...
//Ans:
let invitedPersons: string[] = ['Numan','Araf','Ahmad', 'Sami']
...
//Ans:
let player1: string = "Rashid Munir"
...
make_shirt("Large", "Rashid Developer.");
...
make_album({artist:'Rashid',title: 'Lifeline'})
